...
elseif (FA * FB) > 0 % Otherwise, if f(a) * f(b) is positive, thereby lacking
    ...
    if k == 1 % if k has been changed from 0 to 1, this means we found a root.
        ...
        % NOTE: Line 110 has been edited for compatibility with
        % FixedPoint_OBrien.m. 
        legend('Fixed-Point Approximation', 'Left End Point (a)', 'Right End Point (b)', 'Root Estimate (p)') % Add legend to tell colors apart
